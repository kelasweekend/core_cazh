        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item {{ request()->is('v1') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ request()->is('v1/companies*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ request()->is('v1/employees*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item {{ request()->is('v1/transactions*') ? 'active' : '' }}">
